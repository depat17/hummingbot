...
from .micro_profit_maker_order_tracker import MicroProfitMakerOrderTracker
...
cdef class MicroProfitMakerStrategy(StrategyBase):
    ...
    def init_params(self,
        ...
        self._sb_order_tracker = MicroProfitMakerOrderTracker()
